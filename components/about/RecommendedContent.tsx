  ...
  return (
    <Collapse title="Recommended" className="w-full mb-4">
      <div className="prose dark:prose-invert prose-sm max-w-none">
        ...
        <h4 className="text-base font-medium mt-4">Papers</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Essays</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Blog Posts</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Lectures</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Reviews</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Cases</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Dossiers</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Conspiracies</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Notes</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Verse</h4>
        <ul>
        ...
        <h4 className="text-base font-medium mt-4">Pages</h4>
        <ul>
