...
const menuItems = [
  ...
  // { icon: Waypoints, label: "Memories", path: "/memories" },
  ...
  // { icon: Pencil, label: "Write", path: "/write" },
  ...
  // { icon: Lightbulb, label: "Method", path: "/method" },
  // { icon: Rocket, label: "Learn", path: "/learn" },
