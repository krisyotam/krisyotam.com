...
export function MangaCard({ id, title, imageUrl, volumes, chapters, rating }: MangaCardProps) {
  return (
        ...
        <div className="flex-1 p-3 overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between mt-1">
            ...
            <Button variant="outline" size="sm" className="h-7 text-xs px-2">
              <a href={`https://myanimelist.net/manga/${id}`} target="_blank" rel="noopener noreferrer">
                Info
              </a>
            </Button>
          </div>
