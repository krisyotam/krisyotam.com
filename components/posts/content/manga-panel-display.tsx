...
interface MangaPanelDisplayProps {
  image: string
  mangaTitle: string
  pageName: string
...
export default function MangaPanelDisplay({
  image,
  mangaTitle,
  pageName,
  layout = "vertical",
        ...
        <div className="!flex !flex-col">
          ...
          <div className="!p-3 !space-y-1">
            <div className="!flex !justify-between !items-center !text-xs">
              ...
              <span className="!text-gray-600 dark:!text-gray-400">{pageName}</span>
            </div>
