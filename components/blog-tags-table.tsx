...
export function BlogTagsTable({ tags, searchQuery }: BlogTagsTableProps) {
  const [filteredTags, setFilteredTags] = useState<BlogTag[]>(tags);
  ...
  function getTagUrl(tag: BlogTag) {
