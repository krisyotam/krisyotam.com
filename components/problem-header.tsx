...
const confidenceExplanation = `The confidence tag expresses how well-supported the problem solution is, or how likely its implementation is correct. This uses a scale from "impossible" to "certain", based on the Kesselman List of Estimative Words:
...
Even problems that seem experimental may be worth exploring if their potential utility is significant enough.`

const importanceExplanation = `The importance rating distinguishes between utility problems and those which might be critical to mathematical understanding. Using a scale from 0-10, problems are ranked based on their potential impact on:
...
For example, fundamental problems would rank 9-10, while specialized exercises might rank 0-1.`

const statusExplanation = `The status indicator reflects the current state of the problem solution:

- Abandoned: Problem that has been discontinued
- Notes: Initial prototype or solution sketch
- Draft: Early working version with basic steps
- In Progress: Well-developed solution actively being refined
- Finished: Completed solution with no planned major changes

This helps users understand the maturity and reliability of the solution.`

const frameworkExplanation = `Problem-solving frameworks and their strengths for mathematical work:
...
• Classical: Traditional handwritten mathematical solutions using standard mathematical notation and reasoning.
...
const authorExplanation = `The author field indicates who created or maintains the problem solution. This helps with:
...
Solutions may have multiple contributors or be maintained by organizations.`
  ...
  return (
    <header className={cn("mb-4 relative", className)}>
      ...
      >
        ...
        {backText ? `Return to ${backText}` : "Return to Problems"}
      </Link>
          ...
          {framework && (
            <>
              <HoverCard>
                ...
                <HoverCardContent className="w-80 text-sm bg-card text-card-foreground border-border p-4 font-serif">
                  <div className="space-y-2">
                    <h4 className="font-medium text-foreground">Problem-Solving Frameworks</h4>
          ...
          {author && (
            <>
              <HoverCard>
                ...
                <HoverCardContent className="w-80 text-sm bg-card text-card-foreground border-border p-4 font-serif">
                  <div className="space-y-2">
                    <h4 className="font-medium text-foreground">Problem Author</h4>
