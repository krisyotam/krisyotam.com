...
interface EssaysCategoriesTableProps {
  categories: EssayCategory[];
  searchQuery: string;
}

export function EssaysCategoriesTable({ categories, searchQuery }: EssaysCategoriesTableProps) {
  const [filteredCategories, setFilteredCategories] = useState<EssayCategory[]>(categories);
  ...
  function getCategoryUrl(category: EssayCategory) {
    return `/essays/${category.slug}`;
  }
