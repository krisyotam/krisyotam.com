...
interface NotesCategoriesTableProps {
  categories: NoteCategory[];
  searchQuery: string;
}

export function NotesCategoriesTable({ categories, searchQuery }: NotesCategoriesTableProps) {
  const [filteredCategories, setFilteredCategories] = useState<NoteCategory[]>(categories);
  ...
  function getCategoryUrl(category: NoteCategory) {
    return `/notes/${category.slug}`;
  }
