            ...
            <div className="flex justify-center">
              <div className="relative w-full h-[200px]">
                <div className="dark:block hidden w-full h-full relative">
                  <Image
                    src="https://krisyotam.com/doc/assets/logos/krisyotam-site-sticker-darkmode.gif"
                ...
                <div className="dark:hidden block w-full h-full relative">
                  <Image
                    src="https://krisyotam.com/doc/assets/logos/krisyotam-site-sticker-lightmode.gif"
