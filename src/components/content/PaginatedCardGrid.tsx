/*
+------------------+----------------------------------------------------------+
| FILE             | PaginatedCardGrid.tsx                                    |
| ROLE             | Shared paginated grid layout for card sections           |
| OWNER            | Kris Yotam                                               |
| CREATED          | 2026-02-13                                               |
| UPDATED          | 2026-02-13                                               |
+------------------+----------------------------------------------------------+
| @type component                                                             |
| @path src/components/content/PaginatedCardGrid.tsx                          |
+------------------+----------------------------------------------------------+
| SUMMARY                                                                     |
| Responsive grid with pagination controls. Used by /film, /games, /people    |
| and any route needing paginated card layouts. Supports 1-4 column           |
| responsive breakpoints with configurable items per page.                    |
+-----------------------------------------------------------------------------+
*/
