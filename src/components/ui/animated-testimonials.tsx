...
export const AnimatedTestimonials = ({
  ...
  const getRotation = (index: number) => {
    const rotations = [-8, 5, -3, 7, -5, 3, -7, 8, -2, 6];
      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-none object-cover object-center grayscale hover:grayscale-0 transition duration-300 border border-border"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-none bg-gray-100 dark:bg-neutral-800 border border-border"
            >
