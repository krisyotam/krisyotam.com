...
# @author Kris Yotam
# @type notes
# @path src/app/(content)/notes/content/manuals-of-style/takes-on-llms.mdx
# ==============================================================================
...
importance: 
author: "Kris Yotam"
description: "Preferred terminology, formatting, and technical writing style when documenting and reasoning about LLMs"
tags: [Architecture, Llms, Transformers, Ai, Language Models]
