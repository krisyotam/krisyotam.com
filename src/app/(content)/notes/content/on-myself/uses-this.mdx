...
# @author Kris Yotam
# @type notes
# @path src/app/(content)/notes/content/on-myself/uses-this.mdx
# ==============================================================================
...
importance: 5
author: "Kris Yotam"
description: "A detailed overview of my hardware, software, and tools I use daily for work and personal projects."
tags: [Productivity, Hardware, Software, Setup, Keyboard, Mouse, Development, Tools]
category: on-myself
sequences: []
cover: 
# ==============================================================================
...
<Collapse title="View Setup"><Video 
