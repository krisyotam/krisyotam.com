# ==============================================================================
# DOCUMENT: design-of-this-website.mdx
# TYPE:     NOTES
#
# RATIONALE:
...
# @author Kris Yotam
# @type notes
# @path src/app/(content)/notes/content/website/design-of-this-website.mdx
# ==============================================================================
...
importance: 10
author: "Kris Yotam"
description: "Meta page describing krisyotam.com, the self-documenting website’s implementation, experiments, and technical decisions using Markdown and static hosting."
tags: [Design, Website, Krisyotamcom, Architecture]
category: website
sequences: []
cover: 
# ==============================================================================
