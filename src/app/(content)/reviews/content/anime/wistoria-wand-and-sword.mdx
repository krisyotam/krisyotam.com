<div className="flex flex-col items-center gap-8 mt-4 mb-8">
  <img src="https://i.postimg.cc/W4KZq98J/wistoria-wand-and-sword.jpg" alt="Wistoria Wand & Sword" className="w-80 rounded-md" />
  <RatingDisplay
    ratings={{
      story: 4.3,
      visuals: 4.8,
...
<div className="flex flex-wrap justify-center gap-8 my-8">
  <div className="flex gap-8">
    <img src="https://i.postimg.cc/50KFWsYt/elfaria-albis-serfort.jpg" alt="Elfaria Albis Serfort" className="w-48 rounded-md object-cover aspect-[3/4]" />
    <img src="https://i.postimg.cc/k5cbfJ7K/lihanna-owenzaus.png" alt="Lihanna Owenzaus" className="w-48 rounded-md object-cover aspect-[3/4]" />
  </div>
  <div className="flex gap-8">
    <img src="https://i.postimg.cc/PqhDWpnd/workner-norgramwebp.webp" alt="Workner Norgram" className="w-48 rounded-md object-cover aspect-[3/4]" />
    <img src="https://i.postimg.cc/Tw3WszPS/iris-stellamaris.png" alt="Iris Stellamaris" className="w-48 rounded-md object-cover aspect-[3/4]" />
  </div>
</div>
