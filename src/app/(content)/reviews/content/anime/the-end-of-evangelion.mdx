<div className="flex flex-col items-center gap-8 mt-4 mb-8">
  <img src="https://i.postimg.cc/P5bYzRp2/neon-genesis-evanglion.jpg" alt="Neon Genesis Evangelion" className="w-80 rounded-md" />
  <RatingDisplay
    ratings={{
      story: 4.7,
      visuals: 4.5,
...
<div className="flex flex-wrap justify-center gap-8 my-8">
  <div className="flex gap-8">
    <img src="https://i.postimg.cc/rpJHbjb9/shinji-ikari.jpg" alt="Shinji Ikari" className="w-48 rounded-md object-cover aspect-[3/4]" />
    <img src="https://i.postimg.cc/wMV3RSbm/asuka-langley-soryu.jpg" alt="Asuka Langley Soryu" className="w-48 rounded-md object-cover aspect-[3/4]" />
  </div>
  <div className="flex gap-8">
    <img src="https://i.postimg.cc/63bm63B2/misato-katsuragi.webp" alt="Misato Katsuragi" className="w-48 rounded-md object-cover aspect-[3/4]" />
    <img src="https://i.postimg.cc/d02F0Gf7/rei-ayanami.jpg" alt="Rei Ayanami" className="w-48 rounded-md object-cover aspect-[3/4]" />
  </div>
</div>
