<Notice type="info">
This character creation template has been amalgamated from several templates sourced from Tumblr, Pinterest, and DeviantArt. I wish I knew who to give proper credit to, but I have had backups of them saved in Markdown format for some time and now only refer**One Word:** (Use a single adjective to sum up your character in a nutshell)se a single adjective to sum up your character in a nutshell)Word:** (Use a single adjective to sum up your character in a nutshell)sions.  
</Notice>
