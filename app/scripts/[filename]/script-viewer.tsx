...
export function ScriptViewer({ filename }: ScriptViewerProps) {
  ...
  if (loading) {
    return <div className="text-center">Loading script content...</div>
  }
    ...
    <div className="max-w-5xl mx-auto">
      <div className="border border-border rounded-md overflow-hidden">
        ...
        <div className="p-4 overflow-x-auto">
          <pre className={`text-sm ${theme === "dark" ? "bg-zinc-900" : "bg-gray-50"} p-4 rounded-md overflow-x-auto`}>
            <code>{content}</code>
          </pre>
        </div>
