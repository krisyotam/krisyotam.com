# 19th century hysteria diagnoses at salpêtrière hospital

## Overview

Investigates patient case files and photographic records from Jean-Martin Charcot’s clinic to understand how hysteria was staged and classified.

## Historical Context

This study examines 19th century hysteria diagnoses at salpêtrière hospital within the broader framework of historical taboo subjects and forbidden knowledge. The research draws from primary sources, archaeological evidence, and comparative cultural analysis.
...
The practices and beliefs surrounding 19th century hysteria diagnoses at salpêtrière hospital reveal significant insights into the societies that harbored them. These forbidden aspects of human behavior provide a unique window into the psychological and social dynamics of past civilizations.
...
This investigation into 19th century hysteria diagnoses at salpêtrière hospital contributes to our understanding of the complex relationship between desire, prohibition, and cultural formation throughout human history.
