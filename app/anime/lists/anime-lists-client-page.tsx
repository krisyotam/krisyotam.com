...
export default function AnimeListsClientPage() {
  const [selectedListType, setSelectedListType] = useState<"anime" | "manga">("anime")
    ...
    <div className="min-h-screen dark:bg-[#121212]">
      <div className="max-w-6xl mx-auto p-6">
        <PageHeader
          ...
          importance={7}
        />        <PageDescription
          title="About Anime Lists"
          description="Curated anime collections organized by themes, genres, and personal preferences."
        />

        {/* Tab Navigation */}
        <div className="mb-8">
          <TabSwitcher activeTab="lists" listType="anime" />
        </div>
