...
// Import the metadata from the separate file (Next.js will handle this correctly)
// The metadata will be automatically used by Next.js since it's in the same directory
import './blog-metadata'; // No need to export or assign, just import it
