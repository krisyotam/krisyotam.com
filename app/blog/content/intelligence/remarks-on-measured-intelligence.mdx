...
I took the test the first time scoring "you are smarter than 973 out of 1000 people". Not the worst result sure, but I was not satisfied with it due to the conditions in which I took the 
test. I was taking a break from work, highly stressed, with high anxiety, was interrupted twice, and was working on 4 hours of sleep. This heavily impaired my working memory and usual calculation 
abilities due to mental fatigue. I decided to take the test again later today after a 4-hour nap, a good meal, and with nobody else awake in the house. This time the result was a bit more to 
my satisfaction. "You are smarter than 994 out of 1000 people". This is a result I am much more satisfied with as my current baseline under normal conditions. I am glad to have taken the 
test under stressed conditions as well. This now gives me at least a lower bound of my intelligence assuming no major changes such as brain damage, severe mental illness, or other stifling 
conditions. 
...
|------------------|--------------------------------------------------|----------------------|---------------------|------------|--------------------------------------------|
| Lower Bound      | Worst-case state (e.g., sleep deprived, anxious) | ~125                 | ~140                | ~95th      | First test: 4hr sleep, stressful conditions, 10min remaining |
| Resting / Natural| Comfortable, unstressed baseline state           | **137.8**            | **160.4**           | 99.4th     | Second test: nap, food, peace, 13min remaining |
...
with equivalents from another culture. Regardless, my initial and largest concern is still the same: what is being measured? And is it malleable? After taking the first test among the 
conditions I mentioned above, I also spent quite a bit more time thinking about the nature of intelligence and what they were trying to glean from the tests than the actual questions on the 
test itself. I came to the conclusion that the test is measuring quite a few things. 
<Box>
